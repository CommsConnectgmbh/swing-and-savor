...
// Fetch a single profile by id (null if `id` is falsy or the row is missing).
// Mirrors the inlined `from('profiles').select(...).eq('id', id).maybeSingle()`
// idiom used across the DM and profile screens.
