...
describe('fetchProfile', () => {
  ...
  it('returns the row keyed by id with the default projection', async () => {
    maybeSingleMock.mockResolvedValue({ data: { id: 'a', handle: 'x' }, error: null })
    expect(await fetchProfile('a')).toEqual({ id: 'a', handle: 'x' })
