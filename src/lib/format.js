...
// Handicap mit genau einer Nachkommastelle: 12 → "12.0", 5.25 → "5.3".
// Zuvor als `Number(x).toFixed(1)` über ~9 Screens verstreut. Der Aufrufer
// bleibt weiterhin für die "HC "-Beschriftung und den null-Guard zuständig.
