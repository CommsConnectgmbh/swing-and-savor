...
import { formatCupDate, fmtPts, fmtEur } from '../lib/format'
...
export default function PublicCupScreen() {
  ...
  const dateFmt = formatCupDate(cup.date, { day: '2-digit', month: 'long', year: 'numeric' }, i18n.resolvedLanguage || 'en')
  ...
  if (ec) {
    ...
    if (ec.entry_fee_cents != null) {
      const eur = fmtEur(ec.entry_fee_cents, i18n.resolvedLanguage || 'de')
