          ...
          <div className="flex items-center gap-3 mt-7">
            ...
            {captain && (
              <div className="flex items-center gap-2">
                <Avatar src={captain.avatar_url} name={captain.display_name || captain.handle} size={26} initialsFontSize={12} />
                ...
                <ul className="space-y-2.5">
                  {team.list.map((p, i) => (
                    <li key={i} className="flex items-center gap-2.5">
                      <Avatar src={p.avatar_url} name={p.name} size={28} initialsFontSize={12} />
