...
import { cupInviteUrl } from '../lib/links'
    ...
    <div className="max-w-lg mx-auto animate-fade-up">
      ...
      {shareCup && (
        <ShareSheet
          ...
          url={cupInviteUrl(shareCup.invite_code)}
          text={t('share.cupShareText', { cup: shareCup.name, url: cupInviteUrl(shareCup.invite_code) })}
